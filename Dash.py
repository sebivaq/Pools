...
# Abrir la carpeta donde esta la app: cd \Users\Sebi\Google Drive\Inversiones\Investigacion\Programas de python
# Ejecutar la app: python TEST.py
# Abrir la app en el browser: http://127.0.0.1:8050/
